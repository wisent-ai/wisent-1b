"""Generating with the v2 model: the same prompt, plus controls that name a
direction in a concept subspace rather than only a magnitude."""
...
from .first import DEFAULT_MAX_NEW_TOKENS, GenerationOutput, _aggregate_concept_trace
...
def generate_v2(
    ...
    Args:
        model: a RejRNMv2 model.
        tokenizer: a RejTokenizer.
        prompt: input text.
